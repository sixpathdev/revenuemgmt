...
if (!isset($_SESSION["surname"])) {
  ...
  <?php
    if (empty($_SESSION['bank']) && empty($_SESSION['cardno']) && empty($_SESSION['cardpin'])) {
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Paid taxes<span class="fa fa-chevron-down"></span></a></li>
                  <li><a><i class="fa fa-book"></i> View receipt <span class="fa fa-chevron-down"></span></a></li>
                  <li><a><i class="fa fa-bar-chart-o"></i> Data Presentation <span class="fa fa-chevron-down"></span></a></li>
                  <li><a><i class="fa fa-clone"></i>Layouts <span class="fa fa-chevron-down"></span></a></li>
                </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
